...
#define DRAW_SPHERE(Location) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 30, FColor::Red, true);
#define DRAW_SPHERE_COLOUR(Location, Color) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 8.f, 30, Color, false, 5.f);
